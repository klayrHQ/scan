...
const Template: ComponentStory<typeof AdSection> = (args) => (
  <AdSection {...args} />
);
  ...
  ads: [
    {
      ...
      content: (
        <a href="#">
          <img className="block" src="https://picsum.photos/seed/a/200/150" />
        </a>
      ),
    },
    {
      ...
      content: (
        <a href="#">
          <img className="block" src="https://picsum.photos/seed/b/200/150" />
        </a>
      ),
    },
    {
      ...
      content: (
        <a href="#">
          <img className="block" src="https://picsum.photos/seed/c/200/150" />
        </a>
      ),
    },
  ],
