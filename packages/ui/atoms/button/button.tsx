...
const buttonCVA = cva(["cursor-pointer border-2 border-solid box-border"], {
  variants: {
    type: {
  ...
  compoundVariants: [
    {
      ...
      hover: true,
      className:
        "hover:border-surface-1 hover:bg-surface-1 hover:text-onSurfaceHigh",
    },
    {
      type: "secondary",
      hover: true,
  ...
  return (
    <div
      className={buttonCVA({
        ...
        disabled,
        size,
        className: cls([className, width ? `w-${width}` : ""]),
      })}
      {...props}
    >
      <Typography
