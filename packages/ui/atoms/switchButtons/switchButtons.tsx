...
const buttonCVA = cva(["cursor-pointer border-none"], {
  variants: {
    type: {
...
export const SwitchButtons = ({
  ...
  return (
    <div
      className={cls(["divider divide-x-[1px] divide-surface-6", className])}
    >
      {buttons &&
        buttons[0] &&
          ...
          return (
            <button
              ...
              className={buttonCVA({
                ...
                type,
                active:
                  activeButton?.toLowerCase() === button.label.toLowerCase(),
                className: cls([
                  i === 0 && "rounded-l-xl",
