...
export const NewsGrid = ({ newsItems }: { newsItems: NewsItemRefType[] }) => {
            ...
            <div className={"gap-2 grid grid-cols-4 sm:flex sm:flex-col"}>
              ...
              >
                <img
                  ...
                  src={item?.imgObj.url || ""}
                  alt={item?.imgObj.alt}
                  title={item?.imgObj.title}
                  height={200}
                  width={800}
                />
              </div>
              <Grid
                className={"col-span-3 sm:w-full mx-2 py-2 md:py-1"}
                columns={1}
                flex
                gap={0}
              >
                ...
                <Typography bold color={"primary"} tag={"span"}>
                  {item?.title}
                </Typography>
                <Typography
                  size={"subBody"}
