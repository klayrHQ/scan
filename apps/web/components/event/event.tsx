...
export const Event = ({ event }: { event: EventType }) => {
  return (
    <Container section>
      ...
      {event ? (
        <Grid
          className={"max-w-app w-app mx-auto gap-4"}
          flex
          gap={4}
          columns={1}
        >
              ...
              value={
                <AvatarAddress
                  value={{
                    ...
                    name: event?.data?.senderUserName,
                  }}
                />
              }
              valueSize={"body"}
              ...
              value={
                <AvatarAddress
                  value={{
                    ...
                    name: event?.data?.recipientUserName,
                  }}
                />
              }
              valueSize={"body"}
          ...
          {event?.data?.generatorAddress && (
            <KeyValueRow
              ...
              value={
                <AvatarAddress
                  value={{
                    address: event.data.generatorAddress,
                    name: event?.data?.generatorUserName,
                  }}
                />
              }
              valueSize={"body"}
          ...
          {event?.data?.validatorAddress && (
            <KeyValueRow
              ...
              value={
                <AvatarAddress
                  value={{
                    address: event.data.validatorAddress,
                    name: event?.data?.generatorUserName,
                  }}
                />
              }
                    ...
                    event?.name === "mint"
                      ...
                      : event?.name === "transfer"
                        ...
                        : event?.name === "lock"
                          ...
                          : event?.name === "unlock"
                            ? "unlocked"
                            : event?.name === "rewardMinted"
                              ? "minted"
                              : event?.name === "burn"
                                ? "burnt"
                                : event?.name === "validatorStaked"
                                  ? "staked"
                                  : ""
                  }`}
                </Typography>
          ...
          {event?.data?.generatorAmount && (
            <KeyValueRow
              ...
              value={
                <ValueFormatter
                  value={event.data.generatorAmount}
                  format={"currency"}
                  type={"beddows"}
                />
              }
          ...
          {event?.data?.initializationFee && (
            <KeyValueRow
              ...
              value={
                <ValueFormatter
                  value={event.data.initializationFee}
                  format={"currency"}
                  type={"beddows"}
                />
              }
          ...
          {event?.data?.oldCommission && (
            <KeyValueRow
              ...
              value={
                <ValueFormatter
                  value={event.data.oldCommission}
                  format={"percentage"}
                  type={"number"}
                />
              }
          ...
          {event?.data?.newCommission && (
            <KeyValueRow
              ...
              value={
                <ValueFormatter
                  value={event.data.newCommission}
                  format={"percentage"}
                  type={"number"}
                />
              }
          ...
          {event?.data?.lastCertificate && (
            <KeyValueRow
              ...
              value={
                <ValueFormatter
                  value={event.data.lastCertificate.timestamp.toString()}
                  format={"date"}
                  type={"timestamp"}
                />
              }
          ...
          {event?.data?.ccm && (
            <Grid className={"gap-4 w-full mx-auto"} flex columns={1}>
              ...
              <KeyValueRow
                ...
                value={
                  event.data.ccm.sendingChainName ||
                  event.data.ccm.sendingChainID
                }
                valueSize={"body"}
              />
              <KeyValueRow
                ...
                value={
                  event.data.ccm.receivingChainName ||
                  event.data.ccm.receivingChainID
                }
                valueSize={"body"}
              />
              <KeyValueRow
