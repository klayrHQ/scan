...
export const JsonItem = ({
  ...
  const lightStyles = {
    ...
    basicChildStyle: cls(["pl-3 ml-[0.175rem] border-solid border-1 border-r-0 border-t-0 border-b-0 border-surface-3", childClassName]),
  ...
  const parsedJSON = JSON.parse(src)

  return (
    <div className={"w-app mx-auto relative"}>
      <JsonView data={parsedJSON} style={lightStyles} />
      {/*{
        copy &&
